    ...
    <div class="flex flex-1 flex-col px-6 py-12 lg:px-12">
      <div class="w-full max-w-3xl mx-auto">
        ...
        <div class="mb-8">
          ...
          <p class="mt-2 text-sm text-gray-600">Details of patient #{{ $patient->id }}</p>
        </div>
        ...
        <div class="bg-white rounded-xl shadow p-6 space-y-4">
          ...
          <div>
            ...
            <p class="text-lg text-gray-900">{{ $patient->email }}</p>
          </div>
        ...
        <div class="mt-6 flex gap-3"> 
          <a href="{{ route('patients.histories.index', $patient->id) }}"
             class="px-4 py-2 rounded-md bg-blue-600 text-white font-semibold hover:bg-blue-500">
            History
          </a>
